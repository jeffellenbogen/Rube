...
const CATALOG = {
  ...
  materials: [
    { subtype: 'domino', label: 'Domino', type: 'material', defaultW: 8, defaultH: 16 },
    { subtype: 'ball', label: 'Ball', type: 'material', defaultW: 12, defaultH: 12 },
    { subtype: 'toyCar', label: 'Toy Car', type: 'material', defaultW: 24, defaultH: 14 },
